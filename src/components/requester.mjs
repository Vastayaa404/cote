...
import debug from 'debug'; // TODO
const log = debug('axon:req');
// import('debug').then(({default: debug}) => { const log = debug('axon:req')}); //Call after import

const SUBSET_IDENTIFIER = '__subset';

export class Requester extends Monitorable(Configurable(Component)) {
